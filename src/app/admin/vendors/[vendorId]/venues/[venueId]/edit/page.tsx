...
export default function EditVenuePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        router.push(`/admin/vendors/${vendorId}/venues/${venueId}`)
      } else {
  ...
  if (loading) {
    return (
      <AdminPageSkeleton
        title="Edit Venue"
        subtitle="Loading venue details..."
        showBasicInfo={true}
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Link href={`/admin/vendors/${vendorId}/venues/${venueId}/courts/new`}>
                    ...
                    {venue.courts.map((court) => (
                      <div key={court.id} className="border rounded-lg p-4 space-y-3">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <Link href={`/admin/vendors/${vendorId}/venues/${venueId}/courts/${court.id}/edit`}>
